...
locationsRouter.get("/get", (req, res) => {
    let sqlSelect = "SELECT * FROM hr.locations;";
...
locationsRouter.post("/post", (req, res) => {
...
locationsRouter.put("/put", (req, res) => {
...
locationsRouter.delete("/delete/:JOB_ID", (req, res) => {
